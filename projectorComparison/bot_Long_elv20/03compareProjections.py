...
parser.add_argument("--title", default="Errors projecting single $1 \\times 1 \\times 1$ voxel, setup of Long et. al. with $\\sim 20^\\circ$ elevation")
...
line, = plt.plot(csv["Angle"], 100*csv["Siddon8"]/csv["Baseline"], label="Siddon8")
